...
const tableData = [
  {
    ...
    marketCap: '₹17,82,541 Cr',
    marketPrice: '₹2,724.30',
    growthType: true,
    value: '+3.45%',
  ...
  },
  {
    ...
    marketCap: '₹12,27,685 Cr',
    marketPrice: '₹3,423.00',
    growthType: true,
    value: '+2.02%',
    sector: 'IT Services'
  },
  {
    company: 'HDFC Bank',
    marketCap: '₹7,74,421 Cr',
    marketPrice: '₹1,385.10',
    growthType: false,
    value: '-0.70%',
    sector: 'Banks'
  },
  {
    company: 'Infosys',
    marketCap: '₹6,19,955 Cr',
    marketPrice: '₹1,508.00',
    growthType: true,
    value: '+1.99%',
    sector: 'IT Services'
  },
  {
    ...
    marketCap: '₹5,42,391 Cr',
    marketPrice: '₹2,284.80',
    growthType: false,
    value: '-1.02%',
...
const headerStyle = {
  color: 'var(--gray700)',
  borderBottom: 'dashed 1px var(--gray700)'
};
  ...
  <Table {...args}>
    <Table.Header>
      <Table.HeaderCell
        style={
          {
            ...{ paddingLeft: '5%', paddingTop: '16px', paddingBottom: '16px' },
            ...headerStyle
          }
        }
      >
      ...
      <Table.HeaderCell
        style={
          {
            ...{ paddingRight: '5%', paddingTop: '16px', paddingBottom: '16px' },
            ...headerStyle
          }
        }
      >
          ...
          >
            ...
            <Table.Cell>
              ...
              >
                ...
                <span
                  className={` bodySmall ${data.growthType ? 'contentAccent' : 'contentNegative'}`}
                >
                ( {data.value} )
                </span>
              </div>
